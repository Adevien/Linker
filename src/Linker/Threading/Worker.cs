...
namespace Linker
{
    class Worker
    {
        ...
        private static TaskScheduler CurrentTaskScheduler => SynchronizationContext.Current != null ? TaskScheduler.FromCurrentSynchronizationContext() : TaskScheduler.Default;
